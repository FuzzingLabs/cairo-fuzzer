...
impl InputDatabaseU8 for EmptyDatabase {
...
impl MutatorU8 { 
    ...
    pub fn mutate<T: InputDatabaseU8>(&mut self, mutations: usize, inputs: &T) {
        /// List of mutation strategies which do not require an input database
        const STRATEGIES: &[fn(&mut MutatorU8)] = &[
            MutatorU8::shrink,
            MutatorU8::expand,
            MutatorU8::bit,
            MutatorU8::inc_byte,
            ...
            MutatorU8::swap,
            MutatorU8::copy,
            MutatorU8::inter_splice,
            MutatorU8::insert_rand,
            MutatorU8::overwrite_rand,
            MutatorU8::byte_repeat_overwrite,
            MutatorU8::byte_repeat_insert,
            MutatorU8::magic_overwrite,
            MutatorU8::magic_insert,
            MutatorU8::random_overwrite,
            MutatorU8::random_insert,
            MutatorU8::splice_overwrite,
            MutatorU8::splice_insert,
        ];
        ...
        for _ in 0..mutations {
            ...
            let splice_overwrite = core::ptr::eq(strat as *const (),
                MutatorU8::splice_overwrite as *const ());
            let splice_insert = core::ptr::eq(strat as *const (),
                MutatorU8::splice_insert as *const ());
